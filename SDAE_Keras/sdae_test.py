...
cur_sdae = StackedDenoisingAE(
    n_layers=3, n_hid=[400], dropout=[0.1], nb_epoch=20)
...
model, (dense_train, dense_val, dense_test), recon_mse = cur_sdae.get_pretrained_sda(
    X_train, X_test, X_test, dir_out='../output/')
