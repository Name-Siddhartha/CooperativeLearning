...
enhance_visual = visual_enhance

audio_enhance = enhance_con(common_value_a, feature_size, audio_size)
enhance_audio = audio_enhance

textual_enhance = enhance_con(common_value_t, feature_size, textual_size)
enhance_textual = textual_enhance

#################################################################################################
distribution_v = gen_distribution(enhance_visual, visual_size)
distribution_a = gen_distribution(enhance_audio, audio_size)
distribution_t = gen_distribution(enhance_textual, textual_size)
