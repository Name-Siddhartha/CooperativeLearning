...
# This is the proprietary package
from gen_shuffle_batch_data import GenBatchDataNew
from GetEvlData import get_multi_data
...
train_writer = tf.summary.FileWriter(
    logdir='/home/wei/TestData/clean_data/train')
test_writer = tf.summary.FileWriter(
    logdir='/home/wei/TestData/clean_data/test')
...
def train_model():
    with tf.Session() as sess:
        with tf.device("/gpu:0"):
            train_data_genor = GenBatchDataNew(64,
                                               l_file='/home/wei/TestData/clean_data/label_train.h5',
                                               v_file='/home/wei/TestData/clean_data/visual_train_normal2.h5',
                                               a_file='/home/wei/TestData/clean_data/audio_train_normal2.h5',
                                               t_file='/home/wei/TestData/clean_data/textual_train_normal2.h5')

            label_list, multi_list = get_multi_data(f_label='/home/wei/TestData/clean_data/label_test.h5',
                                                    f_visual='/home/wei/TestData/clean_data/visual_test_normal2.h5',
                                                    f_audio='/home/wei/TestData/clean_data/audio_test_normal2.h5',
                                                    f_textual='/home/wei/TestData/clean_data/textual_test_normal2.h5')
